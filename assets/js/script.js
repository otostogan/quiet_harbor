...
/* harmony import */ var _modules_bgresize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/bgresize */ "./src/js/modules/bgresize.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_bgresize__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])({
    modalSelector: '.modal-contact',
    triggerSelector: '[data-modal-contact]'
  });
  Object(_modules_mask__WEBPACK_IMPORTED_MODULE_4__["default"])('[data-number]');
  Object(_modules_checkTextinput__WEBPACK_IMPORTED_MODULE_5__["default"])('[data-text]');
});
...
var resize = function resize() {
  var bg = document.querySelector('.main__back'),
      bluer = document.querySelector('.main__blur'),
      content = document.querySelector('.main__content'),
      slider = document.querySelector('.main');
  var initheigh = 660;

  var calculate = function calculate(onElement, bluer) {
    var width = +window.getComputedStyle(bluer).width.replace(/[^+\d]/g, '');
  ...
  var width = function width(init) {
    var width = +window.getComputedStyle(bluer).width.replace(/[^+\d]/g, '');
    var bgwidth = width - window.getComputedStyle(bluer).left.replace(/[^+\d]/g, '') - 15;
    content.style.width = "".concat(bgwidth, "px");
    var heightContent = +window.getComputedStyle(content).height.replace(/[^+\d]/g, '') + +window.getComputedStyle(content).top.replace(/[^+\d]/g, '') + 110;

    if (heightContent > init) {
      var slides = document.querySelectorAll('.main__slider img');
      slides.forEach(function (item) {
        item.style.height = "".concat(heightContent, "px");
      });
      bluer.style.height = "".concat(heightContent, "px");
      bg.style.height = "".concat(heightContent + 90, "px");
    } else {
      var _slides = document.querySelectorAll('.main__slider img');

      var slideH = +window.getComputedStyle(content).top.replace(/[^+\d]/g, '') + +window.getComputedStyle(content).height.replace(/[^+\d]/g, '');
      console.log();

      _slides.forEach(function (item) {
        item.style.height = "".concat(slideH + 50, "px");
      });

      bluer.style.height = "".concat(slideH + 50, "px");
      bg.style.height = "".concat(slideH + 100, "px");
    }
  };
...
var header = function header() {
  ...
  window.addEventListener('scroll', function () {
    if (document.documentElement.scrollTop > 340) {
      ...
      header.style = 'position: fixed; z-index: 1000; top: 0; box-shadow: 10px 10px 50px rgba(0, 0, 0, 0.08);';
	...
	if(window.screen.availWidth <= 768){
			const items = document.querySelectorAll('.header__menu .menu-item-has-children .sub-menu');
			const links = document.querySelectorAll('.header__menu .menu-item-has-children');
...
jQuery(document).ready(function ($) {
  ...
  try {
    $(document).ready(function () {
      var url = document.querySelector('[data-arrow]').dataset.arrow;
      $('.review__slider').slick({
        dots: false,
        infinite: true,
        prevArrow: "<button type=\"button\" class=\"slick-prev\"><img src=\"".concat(url, "slider/arrows/left.svg\"></button>"),
        nextArrow: "<button type=\"button\" class=\"slick-next\"><img src=\"".concat(url, "slider/arrows/right.svg\"></button>"),
        responsive: [{
          breakpoint: 1200,
          settings: {
            arrows: false,
